        ...
        return (
           <tr>
               ...
               <td className='profile-actions'>
                   ...
                   <button><Link to={"/EditAdvaticement/"+this.props.obj._id} className="btn btn-success">Edit</Link></button>
                   {/* <br/><br/> */}  &nbsp;
                   <button onClick={this.delete} className="btn btn-danger">Delete</button>
                   <br/><br/>
<button type='submit' className='pay'><Link to={"/APayment/"+this.props.obj._id} className="btn btn-info">Pay</Link></button>
               </td>
           </tr>
        );
    }
